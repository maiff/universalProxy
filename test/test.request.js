...
describe('test request', function () {
  it('get', function (done) {
    request('get', 'http://dict.youdao.com/fsearch', {data: {q: 'test'}})
    .then(text => {
  ...
  it('get with cookie', function (done) {
    request('get', 'http://120.77.37.119:30002/getMyList', {
      withCookie: 1,
      data: {_cookie: 'sessionId=%229be3d76ed487a41188e104b0bc45381243ec40b8e46e85a2153e04e3b45a518a%22; name=%22%u5411%u738B%u6D9B%22'}})
    .then(text => {
      console.log(text)
      done()
    })
